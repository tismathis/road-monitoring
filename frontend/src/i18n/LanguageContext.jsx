...
const translations = {
  en: {
    ...
    'nav.groupControlPanel': 'Control Panel', 'nav.groupUrgent': 'Urgent', 'nav.groupStats': 'Stats',
    ...
    'severity.fatal': 'Fatal', 'severity.serious': 'Serious', 'severity.serious_injury': 'Serious injury', 'severity.minor': 'Minor', 'severity.damage_only': 'Damage only',
    ...
    'graph.neural3d': '3D Neural Network — City Overview',
    ...
    'graph.liveMonitored': 'live monitored', 'graph.liveMonitoredRing': 'Live Camera (ring)', 'graph.noCamera': 'No Camera',
    'graph.confidence': 'Confidence', 'graph.accelerationAnomaly': 'Acceleration Anomaly (α)',
    'graph.trajectoryAnomaly': 'Trajectory Anomaly (β)', 'graph.angleChangeAnomaly': 'Angle-Change Anomaly (γ)',
  ...
  fr: {
    ...
    'nav.groupControlPanel': 'Panneau de contrôle', 'nav.groupUrgent': 'Urgent', 'nav.groupStats': 'Statistiques',
...
const frenchFallbacks = {
  ...
  'incidents.title': 'Événements et incidents', 'incidents.filter': 'Filtrer par sévérité :', 'incidents.all': 'Tous', 'severity.fatal': 'Mortel', 'severity.serious': 'Grave', 'severity.serious_injury': 'Blessure grave', 'severity.minor': 'Mineur', 'severity.damage_only': 'Dégâts matériels uniquement',
  ...
  'graph.segmentId': 'ID du segment', 'graph.roadId': 'ID de la route', 'graph.roadType': 'Type de route', 'graph.type': 'Type', 'graph.state': 'État',
  ...
  'graph.reset': 'Réinitialiser', 'graph.accidentActive': 'Accident / Alerte active',
  ...
  'graph.liveMonitored': 'surveillance en direct', 'graph.liveMonitoredRing': 'Caméra en direct (anneau)', 'graph.noCamera': 'Aucune caméra',
  'graph.confidence': 'Confiance', 'graph.accelerationAnomaly': 'Anomalie d’accélération (α)',
  'graph.trajectoryAnomaly': 'Anomalie de trajectoire (β)', 'graph.angleChangeAnomaly': 'Anomalie de changement d’angle (γ)',
