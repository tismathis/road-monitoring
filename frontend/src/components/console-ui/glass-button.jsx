...
function __OriginkitBase_LiquidGlassButton(props) {
    const {
        label = "GLASS BUTTON",
...
export default function LiquidGlassButton(props) {
  return <__OriginkitBase_LiquidGlassButton {...__originkitPresetProps} {...props} />;
}
